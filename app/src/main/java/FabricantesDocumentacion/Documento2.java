...
public class Documento2 extends AppCompatActivity {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_documento2);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    InputStream inputStream = getAssets().open("2 B) F160QM51 V2.pdf");
    ...
    private void savePdfToDevice() {
        try {
            ...
            File pdfFile = new File(pdfManualDirectory, "F160QM51 V2.pdf");
