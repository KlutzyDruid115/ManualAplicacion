...
public class Documento22 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    InputStream inputStream = getAssets().open("22 A) IS54268.pdf");
    ...
    private void savePdfToDevice() {
        try {
            ...
            File pdfFile = new File(pdfManualDirectory, "IS54268_saved.pdf");
