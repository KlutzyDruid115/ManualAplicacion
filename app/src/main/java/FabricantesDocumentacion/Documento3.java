...
public class Documento3 extends AppCompatActivity {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_documento3);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    InputStream inputStream = getAssets().open("3 B) IS0119SO.pdf");
    ...
    private void savePdfToDevice() {
        try {
            ...
            File pdfFile = new File(pdfManualDirectory, "IS0119SO_saved.pdf");
