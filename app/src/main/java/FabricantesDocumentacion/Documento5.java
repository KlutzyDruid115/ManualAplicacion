...
public class Documento5 extends AppCompatActivity {
    PDFView pdfView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_documento5);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    InputStream inputStream = getAssets().open("5 D)IS00252.pdf");
    ...
    private void savePdfToDevice() {
        try {
            ...
            File pdfFile = new File(pdfManualDirectory, "IS00252_saved.pdf");
