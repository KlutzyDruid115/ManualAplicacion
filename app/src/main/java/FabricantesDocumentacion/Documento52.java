...
public class Documento52 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    InputStream inputStream = getAssets().open("52 B) IG 2019.15.pdf");
    ...
    private void savePdfToDevice() {
        try {
            ...
            File pdfFile = new File(pdfManualDirectory, "IG 2019.15_saved.pdf");
